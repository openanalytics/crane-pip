...
server_parser.add_argument('url', help = "Index url to forward the requests to. Note, the url should have already been registered by the 'crane index register' command.")
server_parser.add_argument('--port', '-p', help = 'port to serve the proxy under.', default=9999)
